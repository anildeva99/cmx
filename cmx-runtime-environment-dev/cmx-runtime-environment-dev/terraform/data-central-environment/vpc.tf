...
resource "aws_vpc" "environment_vpc" {
  ...
  tags = merge(
    ...
    {
      Name  = "CodaMetrix Data Central VPC - environment_vpc - ${var.environment}"
      Type  = "environment_vpc"
    }
  )
}
...
resource "aws_subnet" "public_subnet_1" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name                                        = "CodaMetrix Data Central VPC - public_subnet_1"
...
resource "aws_subnet" "private_subnet_1" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name                                        = "CodaMetrix Data Central VPC - private_subnet_1"
...
resource "aws_subnet" "public_subnet_2" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name                                        = "CodaMetrix Data Central VPC - public_subnet_2"
...
resource "aws_subnet" "private_subnet_2" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name                                        = "CodaMetrix Data Central VPC - private_subnet_2"
...
resource "aws_subnet" "dmz_subnet" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name     = "CodaMetrix Data Central VPC - dmz_subnet"
      Type     = "dmz_subnet"
      Exposure = "dmz"
      VPC      = "environment"
    }
...
resource "aws_internet_gateway" "igw" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Data Central VPC - igw"
      Type = "igw"
    }
  )
}
...
resource "aws_route_table" "public_route_table" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Data Central VPC - public_route_table"
...
resource "aws_eip" "eip" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Data Central VPC - eip"
      Type = "eip"
    }
  )
}
...
resource "aws_nat_gateway" "nat_gateway" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Data Central VPC - nat_gateway"
      Type = "nat_gateway"
    }
  )
}
...
resource "aws_route_table" "private_route_table" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Data Central VPC - private_route_table"
