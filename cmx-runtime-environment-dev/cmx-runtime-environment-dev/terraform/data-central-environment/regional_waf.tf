...
resource "aws_wafregional_web_acl_association" "dundas_waf_association" {
  resource_arn = aws_alb.dundas_alb.arn
  web_acl_id   = module.regional_waf.regional_web_acl_id
}
