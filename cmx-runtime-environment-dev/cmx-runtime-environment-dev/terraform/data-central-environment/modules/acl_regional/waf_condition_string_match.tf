resource "aws_wafregional_byte_match_set" "match_admin_url" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-admin-url"

  byte_match_tuples {
    text_transformation   = "URL_DECODE"
    target_string         = var.web_admin_url
...
resource "aws_wafregional_byte_match_set" "match_auth_tokens" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-auth-tokens"

  byte_match_tuples {
    text_transformation   = "URL_DECODE"
    target_string         = var.acl_constraint_match_auth_tokens
  ...
  byte_match_tuples {
    text_transformation   = "URL_DECODE"
    target_string         = var.acl_constraint_session_id
...
resource "aws_wafregional_byte_match_set" "match_csrf_method" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-csrf-method"
...
resource "aws_wafregional_byte_match_set" "match_php_insecure_uri" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-php-insecure-uri"
...
resource "aws_wafregional_byte_match_set" "match_php_insecure_var_refs" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-php-insecure-var-refs"
...
resource "aws_wafregional_byte_match_set" "match_rfi_lfi_traversal" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-rfi-lfi-traversal"
...
resource "aws_wafregional_byte_match_set" "match_ssi" {
  name = "${var.environment}-${var.waf_prefix}-generic-match-ssi"
