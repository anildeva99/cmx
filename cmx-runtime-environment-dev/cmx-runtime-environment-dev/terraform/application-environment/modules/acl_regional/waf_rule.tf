resource "aws_wafregional_rule" "detect_admin_access" {
  ...
  tags = merge(
    ...
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_admin_access"
...
resource "aws_wafregional_rule" "detect_bad_auth_tokens" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_bad_auth_tokens"
...
resource "aws_wafregional_rule" "detect_blacklisted_ips" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_blacklisted_ips"
...
resource "aws_wafregional_rule" "detect_php_insecure" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_php_insecure"
...
resource "aws_wafregional_rule" "detect_rfi_lfi_traversal" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_rfi_lfi_traversal"
...
resource "aws_wafregional_rule" "detect_ssi" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - detect_ssi"
      Type = "detect_ssi"
    }
  )
}
...
resource "aws_wafregional_rule" "enforce_csrf" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - enforce_csrf"
      Type = "enforce_csrf"
    }
  )
}
...
resource "aws_wafregional_rule" "mitigate_sqli" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - mitigate_sqli"
      Type = "mitigate_sqli"
    }
  )
}
...
resource "aws_wafregional_rule" "mitigate_xss" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - mitigate_xss"
      Type = "mitigate_xss"
    }
  )
}
...
resource "aws_wafregional_rule" "restrict_sizes" {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - restrict_sizes"
      Type = "restrict_sizes"
    }
  )
}
...
resource "aws_wafregional_rule" "cmx_rgnl_geo_location_limit_rule" {
  ...
  # Override GeoIP rule for local traffic
  predicate {
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      Name = "CodaMetrix Application Regional WAF Rule - cmx_rgnl_geo_location_limit_rule"
