resource "aws_secretsmanager_secret" "mirth_database_secret" {
  ...
  description             = "Mirth Database credentials for the '${var.environment}' application environment."
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      ...
      Name       = "CodaMetrix Application SecretsManager - mirth_database_secret"
...
resource "aws_secretsmanager_secret" "mirth_database_admin_secret" {
  ...
  description             = "Mirth database credentials for '${var.mirth_database_admin_username}' in the '${var.environment}' application environment."
  kms_key_id              = var.secrets_kms_key_arn
  ...
  tags = merge(
    var.shared_resource_tags,
    {
      ...
      Name       = "CodaMetrix Application SecretsManager - mirth_database_admin_secret"
